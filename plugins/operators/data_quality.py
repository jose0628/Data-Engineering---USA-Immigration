...
class DataQualityOperator(BaseOperator):
    ...
    :param count_template (str): template string for checking if table contains data.
    """
    ui_color = '#89DA59'
    count_template = """
                     SELECT COUNT(*) 
    ...
    def __init__(self,
        ...
        :param query (:obj:`str`, optional): Query use for testing table quality.
        :param result (:obj:`str`, optional): Expected result
        """
    ...
    def execute(self, context):
        """Allows to make data quality checks.
